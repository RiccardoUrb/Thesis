...
def main():
    ...
    # RL model
    path_planning_model_number = '10.h5'
    observation_size = 25
    coverage_model_number = 7
    coverage_observation_size = 100
