...
def animate(drone_list, drone_selection_index, world, media_file_name, duration, save_animation, begin_time):
    ...
    def init_plot(map_object):
        ...
        return fig, ax, ms, drones, objectives, selected_drone, selected_objective, obstacles, trajectory, local_minima, text_step_counter, \
    ...
    def init_animation():
        ...
        return drones, objectives, obstacles, local_minima, trajectory, text_step_counter, drones_coverage,\
               obstacles_coverage, coverage_percentage, drone_0, drone_1, drone_2, drone_3, trajectory_0, trajectory_1, trajectory_2, trajectory_3, \
               objective_0, objective_1, objective_2, objective_3,
    ...
    def main_animation(iteration):
        ...
        return drones, objectives, selected_drone, selected_objective, obstacles, local_minima, plt_color_map,\
               text_step_counter, drones_coverage, obstacles_coverage, covered_area, coverage_percentage, trajectory, \
               drone_0, drone_1, drone_2, drone_3, trajectory_0, trajectory_1, trajectory_2, trajectory_3, \
               objective_0, objective_1, objective_2, objective_3,
    ...
    (fig, ax, ms, drones, objectives, selected_drone, selected_objective, obstacles, trajectory, local_minima, text_step_counter,
